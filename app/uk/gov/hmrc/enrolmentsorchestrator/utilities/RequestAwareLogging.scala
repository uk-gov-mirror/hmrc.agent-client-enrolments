...
package uk.gov.hmrc.enrolmentsorchestrator.utilities
...
/** A logger which is aware of the request. It will append to the message extra information such as session ID, request ID, user agent, referer, and
  * device ID etc.
  *
